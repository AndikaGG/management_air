                        ...
                        <form action='/admin/galon/{{ $galon -> id }}' method="post">
                          ...
                          <div class="form-group">
                            ...
                            <div class="input-group">
                              ...
                              <input style="width: 273%;" autocomplete="off" id="datepickerEdit" value="{{ $galon -> tgl_transaksi }}" name="tgl_transaksi" type="text" class="form-control" placeholder="Tanggal" aria-label="Tanggal" aria-describedby="colored-addon1">
                            </div>
                          </div>
